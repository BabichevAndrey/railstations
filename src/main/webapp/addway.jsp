            ...
            <form action="controller" method="post" id="add_new_way_form">
                 <ul class="properties_list" id="add_new_way">
                				<li class="add_new_way_li">
                                    ...
                                    <li class="add_new_way_li">
                                        <div class="train_list add_new_way number_train_list">
                                            <%  if( request.getSession().getAttribute("wayTrainId") == null){ %>
                                            		 <input type="text" value="" class="float" id="add_way_train_id" name="add_way_train_id" placeholder="<fmt:message key="addway.number" />" autocomplete="off">
                                            <%  } else {  %>
                                                     <input type="text" value="<%= request.getSession().getAttribute("wayTrainId")  %>" class="float" id="add_way_train_id" name="add_way_train_id" placeholder="Number" autocomplete="off">
                                            <%  }   %>
                                        </div>
                                        <div class="train_list add_new_way time_start_train_list">
                                            <%  if( request.getSession().getAttribute("wayTimeDep") == null){ %>
                                                <input type="datetime-local" value="" class="float" id="add_way_dep_time" name="add_way_dep_time" placeholder="" autocomplete="off">
                                            <%  } else {  %>
                                                <input type="datetime-local" value="<%= request.getSession().getAttribute("wayTimeDep")  %>" class="float" id="add_way_dep_time" name="add_way_dep_time" placeholder="" autocomplete="off">
                                            <%  }   %>
                                           </div>
                                        <div class="train_list add_new_way arrive_train_list">
                                            <%  if( request.getSession().getAttribute("wayTimeArrival") == null){ %>
                                               <input type="datetime-local" value="" class="float" id="add_way_arrival_time" name="add_way_arrival_time" placeholder="" autocomplete="off">
                                            <%  } else {  %>
                                               <input type="datetime-local" value="<%= request.getSession().getAttribute("wayTimeArrival")  %>" class="float" id="add_way_arrival_time" name="add_way_arrival_time" placeholder="" autocomplete="off">
                                            <%  }   %>
                                            </div>
                                        ...
                                        <div class="train_list add_new_way cost_station_train_list">
                                            <%  if( request.getSession().getAttribute("wayTicketPrice") == null){ %>
                                               <input type="text" value="" class="float" id="add_way_ticket_price" name="add_way_ticket_price" placeholder="" autocomplete="off">
                                            <%  } else {  %>
                                                <input type="text" value="<%= request.getSession().getAttribute("wayTicketPrice")  %>" class="float" id="add_way_ticket_price" name="add_way_ticket_price" placeholder="Number" autocomplete="off">
                                            <%  }   %>
                                        </div>
                                        <div class="train_list add_new_way free_places_train_list">
                                            <%  if( request.getSession().getAttribute("wayTicketFree") == null){ %>
                                                <input type="text" value="" class="float" id="add_way_ticket_free" name="add_way_ticket_free" placeholder="" autocomplete="off">
                                            <%  } else {  %>
                                                <input type="text" value="<%= request.getSession().getAttribute("wayTicketFree")  %>" class="float" id="add_way_ticket_free" name="add_way_ticket_free" placeholder="Number" autocomplete="off">
                                            <%  }   %>
                    ...
                    <div class="class="search_fields"">
                        <input type="submit" value="<fmt:message key="addway.addnewway" />" id="add_new_way_submit" name="submit_search"/>
                        <input type="hidden" name="command" value="add_new_way">
    				</div>
    			</form>
